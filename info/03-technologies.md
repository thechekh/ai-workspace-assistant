...
rationale lives in [tech-stack.md](../tech-stack.md); concept-level
...
One `AsyncOpenAI` client speaks to **every** hosted provider — Groq, OpenAI,
...
measured comparison: [docs/backend-comparison.md](../docs/backend-comparison.md).
...
three backends via parametrized fixtures; provider quirks (429s, Groq
