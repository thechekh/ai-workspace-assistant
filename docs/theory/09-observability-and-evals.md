...
629 tests, offline, in seconds, $0 (2026-09-10, `uv run pytest -q`). The
...
retrieved chunks the user can inspect); behavior is *pinned* by 629
...
- **629 tests at $0 prove behavior, not intelligence.** Every fake is
