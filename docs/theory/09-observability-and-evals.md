...
621 tests, offline, in seconds, $0 (2026-09-05, `uv run pytest -q`). The
...
retrieved chunks the user can inspect); behavior is *pinned* by 621
...
- **621 tests at $0 prove behavior, not intelligence.** Every fake is
