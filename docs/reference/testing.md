...
| Run | Wall clock | Cost |
|---|---|---|
| the suite, `uv run pytest -q` (2026-09-10) | 18.3 s, 629 passed, nothing skipped | nothing |
...
![The suite tail and the Tier A deep-health JSON: 629 passed, and a degraded status whose only error is the absent Qdrant](../images/testing-suite-and-health.png)

Line by line:

- **`629 passed in 18.27s`** — the whole suite, offline: no network, no
