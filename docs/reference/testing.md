...
| Run | Wall clock | Cost |
|---|---|---|
| the suite, `uv run pytest -q` (2026-09-10) | 28.2 s, 622 passed, nothing skipped | nothing |
...
![The suite tail and the Tier A deep-health JSON: 622 passed, and a degraded status whose only error is the absent Qdrant](../images/testing-suite-and-health.png)

Line by line:

- **`622 passed in 28.24s`** — the whole suite, offline: no network, no
